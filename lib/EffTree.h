...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nBJets;
//   Int_t           nPh;
   Double_t        eventWeightLoose;
   Double_t        eventWeightTight;
   Double_t        pt_probe;
   Double_t        eta_probe;
   Double_t        phi_probe;
   Double_t        met;
...
//   Int_t           EventInOverlap;
   ...
   TBranch        *b_nBJets;   //!
//   TBranch        *b_nPh;   //!
   TBranch        *b_eventWeightLoose;   //!
   TBranch        *b_eventWeightTight;   //!
   TBranch        *b_pt_probe;   //!
   TBranch        *b_eta_probe;   //!
   TBranch        *b_phi_probe;   //!
   TBranch        *b_met;   //!
...
//   fChain->SetBranchAddress("nPh", &nPh, &b_nPh);
   fChain->SetBranchAddress("eventWeightLoose", &eventWeightLoose, &b_eventWeightLoose);
   fChain->SetBranchAddress("eventWeightTight", &eventWeightTight, &b_eventWeightTight);
